...
<form className='w-[70%] rounded-md shadow-md h-[60%] bg-white flex items-center px-5 gap-5'>
    ...
    <input className='w-full md:text-[20px] text-[15px] outline-none' type='text' placeholder='Search items...' value={Search}
...
<span className='absolute top-0 right-1 md:top-2 text-green-500 font-bold md:text-[18px] text-[12px]'>0</span>
        <LuShoppingBag onClick={()=> setcart(true)}  className='md:w-7.5 md:h-7.5 top-3 h-4 w-4 text-green-500'/>
      </div>
    </div>
  )
}
